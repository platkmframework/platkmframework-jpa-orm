 ...
 */
public class SqlSentencesProcessorMariaDB extends SqlSentencesProcessorBase {

    /**
     * SqlSentencesProcessorMariaDB
     */
    private static Logger logger = LoggerFactory.getLogger(SqlSentencesProcessorMariaDB.class);
    ...
    /**
     * Constructor SqlSentencesProcessorMariaDB
     */
    public SqlSentencesProcessorMariaDB() {
        super();
    }
}
