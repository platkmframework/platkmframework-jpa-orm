 ...
 **/
public class SqlSentencesProcessorOracle extends SqlSentencesProcessorBase {

	private static final Logger logger = LogManager.getLogger(SqlSentencesProcessorOracle.class);
	...
	public ProcessResult processSelectOptions(PlatkmEntityManager entyEntityManager, QuerySelect querySelect,
			String tableName, String keyColumn, String textColumns,  WhereCriteria whereCriteria)
			throws DatabaseValidationException { 
		  throw new NotImplementedException(getClass().getName() + " processFastSearch");
	}
*/
