...
public final class JavaValueParser_LOCALDATE extends BasicJavaValueParser<LocalDate> {
	...
	@Override
	public LocalDate readValue(ResultSet rs, int index, String... param) throws SQLException { 
	...
	@Override
	public LocalDate readValue(ResultSet rs, String name, String... param) throws SQLException {
	...
	@Override	
	public Class<?> customParse(){return java.time.LocalDate.class;}
