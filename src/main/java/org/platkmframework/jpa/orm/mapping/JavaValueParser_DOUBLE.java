...
public final class JavaValueParser_DOUBLE extends BasicJavaValueParser<Double> {
     ...
     */
    @Override
    public Double readValue(ResultSet rs, int index, String... param) throws SQLException {
     ...
     */
    @Override
    public Double readValue(ResultSet rs, String name, String... param) throws SQLException {
    ...
    /**
     * JavaValueParser_DOUBLE
     */
    public JavaValueParser_DOUBLE() {
        super();
    }
}
