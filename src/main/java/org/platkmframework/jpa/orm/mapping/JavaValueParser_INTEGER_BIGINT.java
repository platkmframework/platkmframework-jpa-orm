 ...
 */
public final class JavaValueParser_INTEGER_BIGINT extends BasicJavaValueParser<Integer> {
    ...
    /**
     * JavaValueParser_INTEGER_BIGINT
     */
    public JavaValueParser_INTEGER_BIGINT() {
        super();
    }
}
